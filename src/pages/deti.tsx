            ...
            {values.hasChildren && (
              <>
                                  ...
                                  <ul className="govuk-summary-list__actions-list">
                                    ...
                                    >
                                      <a className="govuk-link">
                                        <span aria-hidden="true">Upraviť</span>
                                        <span className="govuk-visually-hidden">
                                          Upraviť {child.priezviskoMeno}
                                        </span>
                                      </a>
                                    </li>
                                    <li
                                    ...
                                    >
                                      <a className="govuk-link">
                                        ...
                                        <span className="govuk-visually-hidden">
                                          Odstrániť {child.priezviskoMeno} zo
                                          zoznamu
                                        </span>
                                      </a>
                                    </li>
                ...
                {taxForm.danovyBonusNaDieta.nevyuzityDanovyBonus.greaterThan(
                  ...
                  <>
                    <p>
                      Podľa vaších príjmov a počtu detí máte nárok na daňový
                      bonus na vyživované dieťa vo výške{' '}
                      {formatCurrency(
                        taxForm.danovyBonusNaDieta.danovyBonus.toNumber(),
                      )}
                      . Ešte máte nevzužitý daňový bonus vo výške{' '}
                      <b>
                        {formatCurrency(
...
export const validate = (values: ChildrenUserInput) => {
  ...
  if (values.hasChildren) {
    ...
    if (values.partner_bonus_na_deti) {
      ...
      } else if (!numberInputRegexp.test(values.r034a)) {
